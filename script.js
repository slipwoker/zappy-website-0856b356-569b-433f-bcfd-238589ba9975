document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
        showFieldError(field, 'Must be no more than ' + field.maxLength + ' characters.');
        return false;
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      successMessage.style.cssText = 'padding:1rem;background:#c6f6d5;color:#276749;border-radius:0.375rem;margin-top:1rem;font-size:0.9375rem;';
  ...
  animationCSS.textContent = [
    ...
    '.' + animationClass + '.fade-in-delay-1{transition-delay:0.1s;}',
    '.' + animationClass + '.fade-in-delay-2{transition-delay:0.2s;}',
    '.' + animationClass + '.fade-in-delay-3{transition-delay:0.3s;}',
    '.' + animationClass + '.fade-in-delay-4{transition-delay:0.4s;}',
    '.' + animationClass + '.fade-in-delay-5{transition-delay:0.5s;}',
    '.' + visibleClass + '{opacity:1 !important;transform:translateY(0) !important;}',
    '@media(prefers-reduced-motion:reduce){.' + animationClass + '{transition:none;opacity:1;transform:none;}}'
  ].join('');
  ...
  if (elementsToAnimate.length > 0) {
    ...
    elementsToAnimate.forEach(function (el) {
      ...
      parentGroups[parent].push(el);
    });

    Object.keys(parentGroups).forEach(function (key) {
      const siblings = parentGroups[key];
      if (siblings.length > 1) {
        siblings.forEach(function (el, index) {
          const delayIndex = Math.min(index + 1, 5);
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "nxty.ai uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '0856b356-569b-433f-bcfd-238589ba9975',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '0856b356-569b-433f-bcfd-238589ba9975';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '0856b356-569b-433f-bcfd-238589ba9975';
